...
<div class="modal fade" id="projectModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newProjectLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">        
        <div class="modal-content">
            <?php echo form_open(site_url("dpanel/project/submit"), "class='NewProject needs-validation' id='frmproject' name='frmproject' novalidate"); ?>
                ...
                <div class="modal-body">
                    <!-- <form class="NewProject" novalidate> -->
                        <!-- Project Selection -->
                        <div class="mb-3 project-select">
                            <label for="projectselect" class="form-label text-primary">Choose project <span class="text-secondary">*</span></label>
                            <select id="project" name="project" class="form-select">
                                <option value="">Choose project</option>
                            </select>
                        </div>
                        <!-- Project Name -->
                        <div class="mb-3 project-input">
