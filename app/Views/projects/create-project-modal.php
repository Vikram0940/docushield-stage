...
<div class="modal fade" id="newproject" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="newProjectLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <?php echo form_open(site_url("dpanel/project/submit"), "class='NewProject needs-validation' id='frmproject' name='frmproject' novalidate"); ?>
                <div class="modal-header">
                    <h3 class="modal-title fw-300 text-16" id="newProjectLabel">Create a New Project</h3>
