    ...
    <div class="container-fluid">
        <div class="inner-subheader mt-2 mb-3">
            ...
            <div class="content-right">
                ...
                ?>
                <input type="hidden" name="project_id" id="parent_id" value="<?=$folder_info->id?>">
                <input type="hidden" name="project_source" id="parent_type" value="2">
        ...
        ?>
        <input type="hidden" name="storage" id="storage" value="<?php echo (isset($segments) && in_array("storage", $segments)) ? 2 : 0; ?>">
        <!-- Mobile Filters -->
        <!-- Custom Filter Panel -->
        <?php
